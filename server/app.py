...
@app.route('/')
def index():
    return '<h1>Grocery Store Server</h1>'
...
class Accounts(Resource):
    ...
    def delete(self, id):
        ...
        if account:
            ...
            db.session.commit()
            return make_response({'result', 'Account delete'}, 200)
        else:
            return make_response({'error': 'Account not found'}, 404)
...
class OrderProductAssociations(Resource):
    ...
    def delete(self, id):
        ...
        if join:
            ...
            db.session.commit()
            return make_response({'result', 'Join delete'}, 200)
        else:
            return make_response({'error': 'Join not found'}, 404)
...
class Orders(Resource):
    ...
    def delete(self, id):
        ...
        if order:
            ...
            db.session.commit()
            return make_response({'result', 'Order delete'}, 200)
        else:
            return make_response({'error': 'Order not found'}, 404)
...
class Products(Resource):
    ...
    def delete(self, id):
        ...
        if product:
            ...
            db.session.commit()
            return make_response({'result', 'Product delete'}, 200)
        else:
            return make_response({'error': 'Product not found'}, 404)
